...
<div class="main-content">
        ...
        <!-- FLASH MESSAGES -->
                          ...
                          <div class="box">
                            <div class="box-header">
                              ...
                              <ul class="nav nav-tabs nav-tabs-left">
                                <li class="active"> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> status list </a></li>
                                <li> <a href="#add" data-toggle="tab"><i class="icon-plus"></i> add status </a></li>
                              </ul>
                              <!-- CONTROL TABS END -->
                            </div>
                              ...
                              <div class="tab-content">
                                    ...
                                    <table aria-describedby="DataTables_Table_0_info" id="DataTables_Table_0" class="dTable responsive dataTable" border="0" cellpadding="0" cellspacing="0">
                                      <thead>
                                        <tr role="row">
                                          ...
                                          <th aria-label="status name.: activate to sort column ascending" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting"><div>status name</div></th>
                                      ...
                                      <tbody aria-relevant="all" aria-live="polite" role="alert">
                                        ...
                                        if(!is_null($all_status))
                                        {
                                          ...
                                          foreach ($all_status as $al_status) {
                                            ...
                                            echo '<td class=" ">'.$al_status->status.'</td>';                                            
                                            ?><td class=" " align="center"><a href="#" rel="tooltip" data-placement="top" data-original-title="edit" class="btn btn-blue"> <i class="icon-wrench"></i> </a> <a href="#" onclick="return confirm('Are you sure you want to delete this record?')" rel="tooltip" data-placement="top" data-original-title="delete" class="btn btn-red"> <i class="icon-trash"></i> </a></td>
                                          </tr>
                                          <?php
                                            $i++;
                                          }
                                ...
                                <div class="tab-pane box" id="add" style="padding: 5px;">
                                  <div style="" class="box-content">
                                    ...
                                    echo form_open('insert/addStatus', $attributes);?>
                                      <div style="" class="padded">
                                        <div class="control-group">
                                          <label class="control-label">status name</label>
                                          <div class="controls">
                                            <input class="validate[required]" name="status" type="text" placeholder="status name" required/>
                                          </div>
                                        </div>
                                        
                                      </div>
                                      <div class="form-actions">
                                        <button type="submit" class="btn btn-blue">add status</button>
                                      </div>
                                    </form>
                                  </div>
                                </div>
                        ...
                        <?php
                            if ($this->session->userdata('add_status')) {
                              if ($this->session->userdata('add_status') == 'y') {
