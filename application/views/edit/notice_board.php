                          ...
                          <div class="box">
                            <div class="box-header">
                              ...
                              <ul class="nav nav-tabs nav-tabs-left">
                                <li class="active"> <a href="#edit" data-toggle="tab"><i class="icon-edit"></i> edit notices </a></li>
                                <li> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> notices list </a></li>
                              ...
                              <div class="tab-content">
                                ...
                                <div class="tab-pane box active" id="edit" style="padding: 5px;">
                                  <div style="" class="box-content">
                                    ...
                                    echo form_open('update/notice', $attributes);?>
                                      <div style="" class="padded">
                                        <?php
                                        if (!is_null($all_notices)) {
                                          foreach ($all_notices as $al_notices) {
                                            if ($al_notices->notice_id == $_GET['key']) {
                                              ?>
                                              <div class="control-group">
                                                <label class="control-label">notice title</label>
                                                <div class="controls">
                                                  <input class="validate[required]" value="<?php echo $_GET['key'];?>" name="notice_id" type="hidden" placeholder="notice id" required/>
                                                  <input class="validate[required]" value="<?php echo $al_notices->notice_title;?>" name="notice_title" type="text" placeholder="notice title" required/>
                                                </div>
                                              </div>
                                              <div class="control-group">
                                                <label class="control-label">notice details</label>
                                                <div class="controls">
                                                  <textarea class="textarea" name="notice_details" placeholder="more details about the notice"  required><?php echo $al_notices->notice_details;?></textarea>
                                                </div>
                                              </div>
                                              <div class="control-group">
                                                <label class="control-label">date due</label>
                                                <div class="controls">
                                                  <input type="text" class="datepicker" value="<?php echo $al_notices->due_date;?>" name="date_due"  data-date-format="yyyy-mm-dd" value="<?php echo date('Y-m-d');?>">
                                                </div>
                                              </div>
                                              ...
                                              <div class="control-group">
                                                ...
                                                <div class="controls">
                                                  ...
                                                  <input class="validate[required]" name="due_time" value="<?php echo $al_notices->due_time;?>"  type="time" placeholder="time due" required/>
                                                </div>
                                              </div>
                                              <?php
                                            } else {
                                      ...
                                      <div class="form-actions">
                                        <button type="submit" class="btn btn-blue">update notice</button>
                                      </div>
                                    </form>
                                  </div>
                                </div>
