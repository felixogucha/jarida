                          ...
                          <div class="box">
                            <div class="box-header">
                              ...
                              <ul class="nav nav-tabs nav-tabs-left">
                                <li class="active"> <a href="#edit" data-toggle="tab"><i class="icon-edit"></i> edit magazines </a></li>
                                <li> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> magazines list </a></li>
                              ...
                              <div class="tab-content">
                                ...
                                <div class="tab-pane box active" id="edit" style="padding: 5px;">
                                  ...
                                  if (!is_null($all_magazines)) {
                                    foreach ($all_magazines as $magz) {
                                      if ($magz->magazine_id == $_GET['key']) {
                                        ?>
                                            ...
                                            if (!is_null($all_publishers)) {
                                              foreach ($all_publishers as $al_publishers) {
                                                if($al_publishers->publisher_Id == $this->session->userdata('publisher_id'))
                                                {
                                                  ...
                                                  echo form_open('update/magazine', $attributes);
                                                  ?>
                                                    ...
                                                    <div style="" class="padded">
                                                      ...
                                                      <fieldset>
                                                        <legend>magazine information</legend>
                                                          ...
                                                          <div class="controls">
                                                            <input class="validate[required]" name="magazine_id" value="<?php echo $_GET['key'];?>" type="hidden" placeholder="added by" readonly/>
                                                            <input class="validate[required]" name="edited_by" value="<?php echo $this->session->userdata('user_id');?>" type="hidden" placeholder="added by" readonly/>
                                                            <input class="validate[required]" value="<?php echo $magz->publisher_name;?>" type="text" placeholder="name of the publisher" readonly/>
                                                          </div>
                                                        </div>
                                                        <div class="control-group">
                                                          <label class="control-label">magazine name</label>
                                                          <div class="controls">
                                                            <input class="validate[required]" value="<?php echo $magz->magazine_name;?>" name="magazine_name" type="text" placeholder="name of the magazine" required/>
                                                          </div>
                                                        </div>
                                                        <div class="control-group">
                                                          <label class="control-label">magazine description</label>
                                                          <div class="controls">
                                                            <textarea class="textarea" name="magazine_desc" placeholder="short description about the magazine"><?php echo $magz->magazine_desc;?></textarea>
                                                          </div>
                                                        </div>
                                                        <div class="control-group">
                                                            ...
                                                            <select name="category_id" id="class_name" class="validate[required]">
                                                              ...
                                                              if (!is_null($all_categories)) {
                                                                foreach ($all_categories as $al_categories) {
                                                                  if ($al_categories->category == $magz->category) {
                                                                    echo '<option selected="selected" value="'.$al_categories->category_id.'">'.$al_categories->category.'</option>';
                                                                  } else {
                                                    ...
                                                    <div class="form-actions">
                                                      <button type="submit" class="btn btn-blue">update magazine</button>
                                                    </div>
                                                  </form>
                                                  <?php
                                                }
