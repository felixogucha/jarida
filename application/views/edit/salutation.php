                          ...
                          <div class="box">
                            <div class="box-header">
                              ...
                              <ul class="nav nav-tabs nav-tabs-left">
                                <li class="active"> <a href="#update" data-toggle="tab"><i class="icon-edit"></i> update salutation </a></li>
                                <li> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> salutation list </a></li>
                              ...
                              <div class="tab-content">
                                ...
                                <div class="tab-pane box active" id="update" style="padding: 5px;">
                                  <div style="" class="box-content">
                                    ...
                                    echo form_open('update/salutation', $attributes);?>
                                    <?php
                                        if(!is_null($all_salutations))
                                        {
                                          ...
                                          foreach ($all_salutations as $al_salutations) {
                                            # code...
                                            if($al_salutations->salutation_id == $_GET['key']) {
                                              ?>
                                              <div style="" class="padded">
                                                <div class="control-group">
                                                  <label class="control-label">salutation</label>
                                                  <div class="controls">
                                                    <input class="validate[required]" name="salutation_id" value="<?php echo $_GET['key']; ?>" type="hidden" placeholder="salutation id" required/>
                                                    <input class="validate[required]" name="salutation" value="<?php echo $al_salutations->salutation?>" type="text" placeholder="salutation" required/>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    <input class="validate[required]" name="salutation_description" value="<?php echo $al_salutations->salutation_description?>" type="text" placeholder="salutation description" required/>
                                                  </div>
                                                </div>
                                              <?php
                                              }
                                      ...
                                      <div class="form-actions">
                                        <button type="submit" class="btn btn-blue">update salutation</button>
                                      </div>
                                    </form>
                                  </div>
                                </div>
