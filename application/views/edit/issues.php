                          ...
                          <div class="box">
                            <div class="box-header">
                              ...
                              <ul class="nav nav-tabs nav-tabs-left">
                                <li class="active"> <a href="#edit" data-toggle="tab"><i class="icon-edit"></i> update an issues </a></li>
                                <li> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> issues list </a></li>
                                    ...
                                    <?php
                                      if(!is_null($all_issues)) {
                                        foreach ($all_issues as $al_issues) {
                                          if ($al_issues->issue_id = $this->input->get('key')) {
                                            ?>
                                            <?php
                                              $attributes = array('class' => 'form-horizontal validatable');
                                              echo form_open_multipart('update/updateIssue', $attributes);
                                              ?>
                                              <fieldset>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                      <select name="magazine_id" id="class_name" class="validate[required]" readonly>
                                                        <option value="">Select magazine</option>
                                                        <?php
                                                        if (!is_null($all_magazines)) {
                                                          foreach ($all_magazines as $al_magazines) {
                                                            if ($al_magazines->magazine_id = $al_issues->magazine_id) {
                                                              echo '<option selected="selected" value="'.$al_magazines->magazine_id.'">'.$al_magazines->magazine_name.'</option>';
                                                            } else {
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                      <input class="validate[required]" value="<?php echo $this->input->get('key');?>" name="issue_id" type="hidden" required/>
                                                      <input class="validate[required]" value="<?php echo $al_issues->issue_no;?>" name="issue_no" type="number" placeholder="issue number" readonly/>
                                                    </div>
                                                  </div>
                                                  <div class="control-group">
                                                    <label class="control-label">issue headline</label>
                                                    <div class="controls">
                                                      <input class="validate[required]" value="<?php echo $al_issues->headline;?>" name="headline" type="text" placeholder="headline for the issue" required/>
                                                    </div>
                                                  </div>
                                                  <div class="control-group">
                                                    <label class="control-label">issue description</label>
                                                    <div class="controls">
                                                      <textarea class="textarea" name="description" placeholder="short description about the issue"><?php echo $al_issues->description;?></textarea>
                                                    </div>
                                                  </div>
                                                  <div class="control-group">
                                                    <label class="control-label">price in dollars ($)</label>
                                                    <div class="controls">
                                                      <input class="validate[required]" value="<?php echo $al_issues->price;?>" name="price" type="text" placeholder="enter price in dollars" required/>
                                                    </div>
                                                  </div>
                                                  <div class="control-group">
                                                      ...
                                                      <select name="tag_id" id="class_name" class="validate[required]">
                                                        ...
                                                        if (!is_null($all_tags)) {
                                                          foreach ($all_tags as $al_tags) {
                                                            if ($al_tags->tag_id = $al_issues->tag_id) {
                                                              echo '<option selected="selected" value="'.$al_tags->tag_id.'">'.$al_tags->tag_name.'</option>';
                                                            } else {
                                                  ...
                                                  <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                      <input type="text" class="datepicker" value="<?php echo $al_issues->created_on;?>" name="created_on" data-date-format="yyyy-mm-dd" placeholder="Date when the issue was published">
                                                    </div>
                                                  </div>
                                              </fieldset>
                                                <div class="form-actions">
                                                  <button type="submit" class="btn btn-blue">update issue</button>
                                                </div>
