...
<div class="main-content">
        ...
        <!-- FLASH MESSAGES -->
                          ...
                          <div class="box">
                            <div class="box-header">
                              ...
                              <ul class="nav nav-tabs nav-tabs-left">
                                <li class="active"> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> roles list </a></li>
                                      ...
                                      <div style="" class="padded">
                                        ...
                                        <fieldset>
                                          ...
                                          <table class="checkbox-table">
                                            <tr>
                                              <th style="text-align:center;" colspan="4"><input type="checkbox" id="check_all" onClick='checkedAll("create_role");' value=""/><label class="css-label" for="check_all">all permissions</label></th>
                                            </tr>
                                            <?php
                        ...
                        <?php
                            if ($this->session->userdata('add_role')) {
                              if ($this->session->userdata('add_role') == 'y') {
                                $msg = 'success! role has been added.';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              } else {
                                $msg = 'sorry! role could not be added. please try again later';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              }
                              $this->session->unset_userdata('add_role');
                            }

                            if ($this->session->userdata('edit_role')) {
                              if ($this->session->userdata('edit_role') == 'y') {
                                $msg = 'success! role has been updated.';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              } else {
                                $msg = 'sorry! role could not be updated. please try again later';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              }
                              $this->session->unset_userdata('edit_role');
                            }

                            if ($this->session->userdata('del_roles')) {
                              if ($this->session->userdata('del_roles') == 'y') {
                                $msg = 'success! role has been deleted.';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              } else {
                                $msg = 'sorry! role could not be deleted. please try again later';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              }
                              $this->session->unset_userdata('del_roles');
                            }
                              ?>
        </div>
