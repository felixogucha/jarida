        ...
        <!-- FLASH MESSAGES -->
                                    ...
                                    <table aria-describedby="DataTables_Table_0_info" id="DataTables_Table_0" class="dTable responsive dataTable" border="0" cellpadding="0" cellspacing="0">
                                      <thead>
                                        <tr role="row">
                                          ...
                                          <th aria-label="salutation: activate to sort column ascending" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting"><div>sal.</div></th>
                                      ...
                                      <tbody aria-relevant="all" aria-live="polite" role="alert">
                                        ...
                                        if(!is_null($all_users))
                                        {
                                          ...
                                          foreach ($all_users as $al_users) {
                                            ...
                                            echo '<td class=" ">'.$al_users->salutation.'</td>';
                                      ...
                                      <div style="" class="padded">
                                          ...
                                          <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <select name="salutation_id" class="validate[required]">
                                                      <option selected="selected" value="">Select salutation</option>
                                                      <?php
                                        ...
                                        <fieldset>
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <input class="validate[required]" name="password" type="text" value="jarida" placeholder="password" readonly/>
                                              <p class="key_info">this is your default password and *MUST* be changed on first login.</p>
                                            </div>
                                          </div>
                                        </fieldset>
                                        <fieldset>
                        ...
                        <?php
                            if ($this->session->userdata('add_user')) {
                              if ($this->session->userdata('add_user') == 'y') {
                                $msg = 'success! user has been added.';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              } else {
                                $msg = 'sorry! user could not be added. please try again later';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              }
                            ...
                            if ($this->session->userdata('edit_user')) {
                              if ($this->session->userdata('edit_user') == 'y') {
                                $msg = 'success! user has been updated.';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              } else {
                                $msg = 'sorry! user could not be updated. please try again later';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              }
                              $this->session->unset_userdata('edit_user');
                            }

                            if ($this->session->userdata('del_user')) {
                              if ($this->session->userdata('del_user') == 'y') {
                                $msg = 'success! user has been deleted.';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              } else {
                                $msg = 'sorry! user could not be deleted. please try again later';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              }
                              $this->session->unset_userdata('del_user');
                            }
                              ?>
        </div>
