...
<div class="main-content">
        ...
        <!-- FLASH MESSAGES -->
                          ...
                          <div class="box">
                            <div class="box-header">
                              ...
                              <ul class="nav nav-tabs nav-tabs-left">
                                <li class="active"> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> magazine tags </a></li>
                        ...
                        <?php
                            ...
                            if ($this->session->userdata('del_tag')) {
                              if ($this->session->userdata('del_tag') == 'y') {
                                $msg = 'success! your tag has been deleted.';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              } else {
                                $msg = 'sorry! could not delete tag. please try again later';
                                echo '<script type="text/javascript">alert("'.$msg.'"); </script>';
                              }
                              $this->session->unset_userdata('del_tag');
                            }
                              ?>
        </div>
